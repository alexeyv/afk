...
- Deliver developer-ready specs with precise handoffs
  ...
  <memories>
    <memory>Amend only for typos; new commit for substantive changes</memory>
  </memories>
  <menu>
    ...
    <item cmd="*create-story" workflow="{project-root}/.bmad/bmm/workflows/4-implementation/create-story/workflow.yaml">Create Story (Required to prepare stories for development)</item>
    <item cmd="*validate-create-story" validate-workflow="{project-root}/.bmad/bmm/workflows/4-implementation/create-story/workflow.yaml">Validate Story (Highly Recommended, use fresh context and different LLM for best results)</item>
